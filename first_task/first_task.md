...
1) Установить пакеты samba bind bind-utils и любой питоновский модуль
    ...
    ![Пункт 1](<first task линукс 1.png>)

    ![Пункт 1](<first task линукс 2.png>)
...
2) Вывести:
    ...
    ![Пункт 2](<first task линукс 3.png>)

    ![Пункт 2](<first task линукс 4.png>)

    ![Пункт 2](<first task линукс 5.png>)
    
    ![Пункт 2](<first task линукс 6.png>)

    ![Пункт 2](<first task линукс 7.png>)
